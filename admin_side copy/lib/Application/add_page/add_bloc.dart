...
import 'package:admin_side/Infrastructure/Respositories/add_salon_repository.dart';
...
class AddSalonBloc extends ChangeNotifier {
  ...
  final AddSalonRepository _repository = AddSalonRepository(); // Initialize the repository
  ...
  Widget displaySelectedImage() {
    if (_pictureResult != null && _pictureResult!.files.isNotEmpty) {
      ...
      return SizedBox.shrink(); // Return an empty widget if no image is selected
    }
  }
